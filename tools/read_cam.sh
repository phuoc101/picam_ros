...
roslaunch picam_ros picam_read.launch record_cam:=false image_width:=2048 image_height:=1536 framerate:=15 bagfile_name:="$BAGFILE_NAME" video_device:=/dev/video2 topics_to_collect:="$TOPICS_TO_COLLECT"
