...
roslaunch picam_ros picam_read.launch record_cam:=true image_width:=3840 image_height:=2880 framerate:=15 bagfile_name:=$BAGFILE_NAME video_device:=/dev/video2 topics_to_collect:=$TOPICS_TO_COLLECT
